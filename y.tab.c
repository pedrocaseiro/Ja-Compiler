...
static const char *const yytname[] =
{
  ...
  "StrLitAux", "ParseArgs", "ExprAux", "Expr", "Type", "IDAux", YY_NULLPTR
};
#endif
...
#line 48 "jac.y" /* yacc.c:1646  */
    {printf("linha: %d\n", N_LINE); (yyval.node) = ast = create_and_insert_node("Program", 1, 2, (yyvsp[-3].node), (yyvsp[-1].node));}
...
#line 134 "jac.y" /* yacc.c:1646  */
    {(yyval.node) = create_and_insert_node("And", 1, 2, (yyvsp[-2].node), (yyvsp[0].node));}
